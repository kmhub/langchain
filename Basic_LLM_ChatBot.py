{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOZUJVyWKgkoJZR71k8TfzJ",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/kmhub/langchain/blob/main/Basic_LLM_ChatBot.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "CYLcDBPgdF8-",
        "outputId": "62ebcde5-796d-41bb-b636-2d843130872b"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "\u001b[?25hRequirement already satisfied: langchain-core<0.3.0,>=0.2.13 in /usr/local/lib/python3.10/dist-packages (from langchain-openai) (0.2.16)\n",
            ...
            "Requirement already satisfied: jsonpatch<2.0,>=1.33 in /usr/local/lib/python3.10/dist-packages (from langchain-core<0.3.0,>=0.2.13->langchain-openai) (1.33)\n",
            "Requirement already satisfied: langsmith<0.2.0,>=0.1.75 in /usr/local/lib/python3.10/dist-packages (from langchain-core<0.3.0,>=0.2.13->langchain-openai) (0.1.85)\n",
            "Requirement already satisfied: packaging<25,>=23.2 in /usr/local/lib/python3.10/dist-packages (from langchain-core<0.3.0,>=0.2.13->langchain-openai) (24.1)\n",
            ...
            "Requirement already satisfied: jsonpointer>=1.9 in /usr/local/lib/python3.10/dist-packages (from jsonpatch<2.0,>=1.33->langchain-core<0.3.0,>=0.2.13->langchain-openai) (3.0.0)\n",
            "Requirement already satisfied: orjson<4.0.0,>=3.9.14 in /usr/local/lib/python3.10/dist-packages (from langsmith<0.2.0,>=0.1.75->langchain-core<0.3.0,>=0.2.13->langchain-openai) (3.10.6)\n",
            "Requirement already satisfied: annotated-types>=0.4.0 in /usr/local/lib/python3.10/dist-packages (from pydantic<3,>=1->langchain-core<0.3.0,>=0.2.13->langchain-openai) (0.7.0)\n",
            ...
            "Successfully installed langchain-openai-0.1.15 tiktoken-0.7.0\n"
          ]
        }
      ],
      "source": [
